...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mTahniah! Anda Dibenarkan menggunakan AUTOSCRIPT GHReyz..\e[0m"
        sleep 5
    else
    echo -e "\e[31mScript Anda Telah Expired !!\e[0m";
    echo -e "\e[31mTolong Renew Dengan Owner Script @GHReyz\e[0m"
    exit 0
    fi
}
...
echo -e "\e[32mPermohonan diterima...\e[0m"
    ...
    echo -e "\e[31mTolong Contact Owner Script Untuk Pembelian @GHReyz !\e[0m"
    rm -f setup.sh
    exit 0
fi
clear
...
echo -e "\e[1;32m════════════════════════════════════════════════════════════\e[0m"
echo ""
echo -e "   \e[1;32mMasukkan Nama Anda (cth : ReyzVPN) "
read -p "   Name : " nm
...
echo -e "\e[1;32m════════════════════════════════════════════════════════════\e[0m"
echo -e ""
echo -e "   \e[1;32mTolong masukkan email Domain/Cloudflare Anda."
echo -e "   \e[1;31m(Tekan ENTER untuk gunakan default email)\e[0m"
read -p "   Email : " email
...
echo ""
echo -e "   .----------------------------------."
echo -e "   |\e[1;32mPilih nombor di bawah \e[0m|"
echo -e "   '----------------------------------'"
echo -e "     \e[1;32m1)\e[0m Masukkan Subdomain Anda"
echo -e "     \e[1;32m2)\e[0m Guna Random Subdomain"
echo -e "   ------------------------------------"
read -p "   Tolong pilih nombor 1-2 atau lain-lain(Random) : " host
echo ""
if [[ $host == "1" ]]; then
...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
echo ""
clear
echo -e "\e[0;32mREADY UNTUK PROSES INSTALLATION...\e[0m"
sleep 2
#install ssh ovpn
echo -e "\e[0;32mINSTALLING SSH & OVPN...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install ohp-server
echo -e "\e[0;32mINSTALLING OHP PORT...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/new-v3/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/${GitUser}/new-v3/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/${GitUser}/new-v3/main/vps.conf"
...
echo ""  | tee -a log-install.txt
echo "    ♦️INFORMASI SSH & OpenVPN♦️" | tee -a log-install.txt
echo "    -------------------------" | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "    ♦️INFORMASI Sqd, Bdvp, Ngnx♦️" | tee -a log-install.txt
echo "    ---------------------------" | tee -a log-install.txt
echo "   - Squid Proxy             : 3128, 8000 (limit to IP Server)"  | tee -a log-install.txt
echo "   - Badvpn                  : 7100, 7200, 7300"  | tee -a log-install.txt
echo "   - Nginx                   : 81"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "    ♦️INFORMASI XRAY♦️"  | tee -a log-install.txt
echo "    ----------------" | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "    ♦️INFORMASI CLASH FOR ANDROID (YAML)♦️"  | tee -a log-install.txt
echo "    -----------------------------------" | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════Autoscript By GHReyz══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         PREMIUM BY @GHReyz          |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
